...
// Keep brand assets stable. Simple Icons supports the Java/CSS3 slugs, but
// avoid the unsupported `viewbox=auto` query parameter. Adobe Media Encoder
// gets its actual SVG asset rather than the generic Adobe mark.
