...
// Keep brand assets stable. Use direct SVG assets for Adobe products that
// are not reliably available through Simple Icons.
...
console.log("logo-loop-fix: fixed Adobe Media Encoder and Adobe Creative Cloud assets");
