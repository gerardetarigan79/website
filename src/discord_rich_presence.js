(() => {
  ...
  const injectStyles = () => {
    ...
    style.textContent = `
      ...
      .rich-activity{display:flex;align-items:center;gap:5px;min-width:0;color:#777;font-size:7px;line-height:1.35}
      .rich-activity-icon{display:grid;place-items:center;flex:0 0 auto;width:12px;height:12px;color:#777}
      .rich-activity-icon svg{width:11px;height:11px;stroke:currentColor;fill:none;stroke-width:1.7;stroke-linecap:round;stroke-linejoin:round}
  ...
  // Small Lucide-style outline icons chosen to match the site's existing line-icon aesthetic.
  const activityIcon = (type) => {
    const icons = {
      0: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M17.32 5H6.68a4 4 0 0 0-3.98 3.59C2.6 9.42 2 14.46 2 16a3 3 0 0 0 3 3c1 0 1.5-.5 2-1l1.41-1.41A2 2 0 0 1 9.83 16h4.34a2 2 0 0 1 1.41.59L17 18c.5.5 1 1 2 1a3 3 0 0 0 3-3c0-1.54-.6-6.58-.69-7.26A4 4 0 0 0 17.32 5Z"/><path d="M6 11h4M8 9v4M15 12h.01M18 10h.01"/></svg>`,
      1: `<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M5.5 12h2.2l1.3-4 2.4 8 1.7-4h2.4"/></svg>`,
      2: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 14a8 8 0 0 1 16 0"/><path d="M3 14v2a2 2 0 0 0 2 2h1v-5H5a2 2 0 0 0-2 2ZM21 14v2a2 2 0 0 1-2 2h-1v-5h1a2 2 0 0 1 2 2Z"/><path d="M19 18a7 7 0 0 1-5 2"/></svg>`,
      3: `<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="m10 9 5 3-5 3V9Z"/></svg>`,
      5: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8 21h8M12 17v4M7 4h10l-1 7a4 4 0 0 1-8 0L7 4Z"/><path d="M7 7H4v1a4 4 0 0 0 4 4M17 7h3v1a4 4 0 0 1-4 4"/></svg>`
    };
    return icons[type] || `<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M12 8v4l3 2"/></svg>`;
  };
