  ...
  return <div className={`recent-carousel${dragging ? " is-dragging" : ""}`} tabIndex={0} onKeyDown={onKeyDown} aria-label="Recent plays carousel">
    <div className="recent-carousel-track">
      {sequence.map((item, index) => {
        ...
        return <article className={`recent-card${activeCard ? " is-active" : ""}`} style={style} key={item.key}>
          <div className="recent-cd-drag-zone" onPointerDown={onCdPointerDown} onPointerMove={onCdPointerMove} onPointerUp={onCdPointerUp} onPointerCancel={onCdPointerCancel} onLostPointerCapture={onCdLostPointerCapture} title="Drag to browse recent plays">
