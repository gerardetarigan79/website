...
if(document.readyState==="loading")document.addEventListener("DOMContentLoaded",replaceAdobeIcons,{once:true});
else replaceAdobeIcons();
new MutationObserver(replaceAdobeIcons).observe(document.getElementById("root"),{childList:true,subtree:true});
