...
function install() {
  ...
  const style = document.createElement("style"); style.textContent = `
    #${CONTROL_ID}{position:fixed;right:12px;top:12px;z-index:60;height:28px;width:28px;padding:0;display:flex;align-items:center;justify-content:center;box-sizing:border-box;border:1px solid #24242a;border-radius:7px;background:#101014;color:#777;box-shadow:0 8px 25px #0006;opacity:0;visibility:hidden;transform:translateY(-12px) scale(.96);transition:width .38s cubic-bezier(.2,.75,.2,1),opacity .55s cubic-bezier(.2,.75,.2,1),transform .7s cubic-bezier(.2,.75,.2,1),visibility 0s linear .7s}
    #${CONTROL_ID}.visible{opacity:1;visibility:visible;transform:none;transition-delay:0s}
    #${CONTROL_ID}.expanded{width:116px}
    ...
    @media(max-width:500px){#${CONTROL_ID}{right:10px;top:10px}#${CONTROL_ID}.expanded{width:100px}#${CONTROL_ID}.expanded .draven-audio-slider-wrap{width:58px}#${CONTROL_ID} .draven-audio-slider{width:58px}}
