...
function install() {
  ...
  const style = document.createElement("style"); style.textContent = `
    ...
    @media(max-width:500px){#${CONTROL_ID}{right:10px;top:10px;min-width:100px}.draven-audio-slider{width:58px}}
